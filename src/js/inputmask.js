        ...
        7215: function (e, t, n) {
          ...
          function l(e, t, n, i, a, s) {
            var c,
              ...
              P = this.opts,
              S = x.maskset,
              O = w.extend(!0, [], S.validPositions),
              _ = w.extend(!0, {}, S.tests),
              M = !1,
              E = !1,
              j = void 0 !== a ? a : r.getLastValidPosition.call(x);
            if (
              (s &&
                ((k = s.begin),
                (b = s.end),
              ...
              (c = 0), (u = (d = o.getTest.call(x, c)).alternation);
            else
              for (; j >= 0; j--)
            ...
            if (void 0 !== u) {
              ...
              for (
                ...
                for (
                  S.tests = {}, r.resetMaskSet.call(x, !0), M = !0, h = 0;
                  h < T.length &&
                  ((g =
                    M.caret || (0 == P.insertMode && null != g)
                      ? r.seekNext.call(x, g)
                      : r.getLastValidPosition.call(x, void 0, !0) + 1),
                  (y = T[h]),
                  (M = f.call(x, g, y, !1, i, !0)));
                  h++
                )
                  h === A && (E = M),
                    1 == e &&
                ...
                if (
                  ...
                  (d = o.getTest.call(x, m)),
                  (S.validPositions = w.extend(!0, [], O)),
                  (S.tests = w.extend(!0, {}, _)),
                  !S.excludes[m])
                ) {
